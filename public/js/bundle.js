...
exports.showConfirmation = exports.showAlert = exports.hideAlert = void 0;
...
var showConfirmation = function showConfirmation(header, message, callback) {
...
var okayHandler = function okayHandler(callback) {
...
var getDialogElement = function getDialogElement(title, msg, callback) {
  ...
  var cnclbtn = document.createElement('a');
...
},{}],"apiCall.js":[function(require,module,exports) {
"use strict";
...
var baseUrl = "".concat(location.protocol, "//").concat(location.host, "/api/v1/");

var apiCall = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(axiousOptions, callback, succcessMsg) {
    var data, url, method, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = axiousOptions.data, url = axiousOptions.url, method = axiousOptions.method;
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success' || res.status === 204) {
              (0, _alert.showAlert)("success", succcessMsg ? succcessMsg : res.data.message);
  ...
  return function apiCall(_x, _x2, _x3) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _apiCall.apiCall)(options, callback, 'Logged In successfully');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _apiCall.apiCall)(options, function () {
              return setTimeout(function () {
                location.assign('/');
              }, 1500);
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            options = {
              method: 'PATCH',
              url: "".concat(baseRoute, "/resetpassword/").concat(token),
              data: data
            };
            _context5.next = 3;
            return (0, _apiCall.apiCall)(options, setTimeout(function () {
              location.assign('/');
            }, 1500), 'Passsword Resetted Successfully');
...
var updatePost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(postID, data) {
    var options, msg;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            options = {
              ...
              url: "posts/".concat(postID ? postID : ''),
              data: data
            };
            console.log(options);
            msg = "Post ".concat(postID ? 'Updated' : 'Created', " Successfully");
            _context.next = 5;
            return (0, _apiCall.apiCall)(options, function () {
              return setTimeout(location.assign('/me/posts'), 1500);
            }, msg);
...
var bookmarkPost = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(postID) {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            like = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
            method = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 'POST';
            model = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : 'posts';
            options = {
              method: method,
              url: "".concat(model, "/").concat(postID, "/").concat(like ? 'like' : 'bookmark')
            };
            _context2.next = 6;
            return (0, _apiCall.apiCall)(options);
  ...
  return function bookmarkPost(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.bookmarkPost = bookmarkPost;
},{"./apiCall":"apiCall.js"}],"userSettings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateData = exports.followUser = exports.deleteAccount = exports.createUser = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            isPassword = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;
            options = {
              method: 'PATCH',
              url: "".concat(route).concat(isPassword ? 'updatepassword' : 'updateme'),
              data: data
            };
            msg = "".concat(isPassword ? 'Password' : 'Details', " Updated Successfully");
            _context.next = 5;
            return (0, _apiCall.apiCall)(options, false, msg);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _apiCall.apiCall)(options, function () {
              return setTimeout(location.assign('/manage-users'), 1500);
            }, "Account Created Successfully");
...
var followUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(userID, method) {
    var options;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _apiCall.apiCall)(options, function () {
              return setTimeout(location.reload(true), 1500);
...
},{"./apiCall":"apiCall.js"}],"commentSettings.js":[function(require,module,exports) {
"use strict";
...
var commentPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(content, postID) {
    var options;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            options = {
              method: 'POST',
              url: "posts/".concat(postID, "/").concat(route),
              data: {
                content: content
              }
            };
            ...
            }, 'Your Comment have been submitted!');
...
},{"./apiCall":"apiCall.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _commentSettings = require("./commentSettings");
...
var postForm = document.querySelector('#post-edit');
var commentForm = document.querySelector('#comment-post-form');
var userEditForm = document.querySelector('#user-edit.form');
var signupForm = document.querySelector('#signup--form');
var forgotPassForm = document.querySelector('#form-forgot-pass');
var userPassForm = document.querySelector('#user-password.form');
...
var createUserForm = document.getElementById('user-create-form');
...
if (bookmarkBtn) bookmarkBtn.addEventListener('click', function () {
  return (0, _postSettings.bookmarkPost)(bookmarkBtn.value);
});
if (likeBtns.length > 0) likeBtns.forEach(function (btn) {
  var model = btn.classList.contains('like-btn--post') ? 'posts' : 'comments';
  btn.addEventListener('click', function () {
    (0, _postSettings.bookmarkPost)(btn.value, true, btn.innerText === 'LIKE' ? 'POST' : 'DELETE', model);
    btn.innerText = btn.innerText === 'LIKE' ? 'DISLIKE' : 'LIKE';
  });
});
if (followButtons.length > 0) followButtons.forEach(function (btn) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              method = btn.classList.contains('btn--red') ? 'DELETE' : 'POST';
              _context.next = 4;
              return (0, _userSettings.followUser)(btn.value, method);
...
if (deleteUserBtns.length > 0) deleteUserBtns.forEach(function (btn) {
  btn.addEventListener('click', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              (0, _alert.showConfirmation)('Delete Account', 'Are you sure you want to delete this account?', function () {
                return (0, _userSettings.deleteAccount)(btn.value);
              });
...
if (postForm) postForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var data, updatePostButton;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            updatePostButton = document.getElementById('update');
            _context3.next = 5;
            return (0, _postSettings.updatePost)(updatePostButton.value, data);
...
if (commentForm) commentForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            postID = document.getElementById('comment-post-btn').value;
            _context4.next = 5;
            return (0, _commentSettings.commentPost)(content, postID);
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            e.preventDefault();
            data = new FormData(userEditForm);
            _context5.next = 4;
            return (0, _userSettings.updateData)(data);
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            e.preventDefault(); //const data = new FormData(createUserForm);
            ...
            _context6.next = 4;
            return (0, _userSettings.createUser)(data);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 5;
            return (0, _userSettings.updateData)(data, true);
...
if (forgotPassForm) forgotPassForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            email = document.getElementById('email').value;
            _context9.next = 5;
            return (0, _login.forgotPassword)({
              email: email
            });
...
if (resetPassBtn) resetPassBtn.addEventListener('click', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _context10.next = 5;
            return (0, _login.resetPassword)(data, resetPassBtn.value);
...
if (searchButton) searchButton.addEventListener('click', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            searchQuery = query ? "".concat(searchButton.value, "=").concat(query) : '';
...
},{"./login.js":"login.js","./postSettings":"postSettings.js","./userSettings":"userSettings.js","./commentSettings":"commentSettings.js","./alert.js":"alert.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
